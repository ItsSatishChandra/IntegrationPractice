        ...
        <nav className="fixed top-0 left-0 w-full bg-white shadow-sm z-50">
            {""}<div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
                ...
                <div className="space-x-6 flex items-center">
                    <SignedIn>
                        <Link href="/mealplan" className="text-gray-700 hover:text-emerald-500 transition-colors">Meal Plan</Link>
                    ...
                    <SignedOut>
                        ...
                        <Link href={isSignedIn ? "/Subscribe" : "/sign-up"} className="text-gray-700 hover:text-emerald-500 transition-colors"
                        > Subscribe </Link>
                        <Link href="/sign-up" className="px-4 py-2 bg-emerald-500 text-white rounded hover:bg-emerald-600 transition"
                        >Sign Up</Link>
                    </SignedOut>
